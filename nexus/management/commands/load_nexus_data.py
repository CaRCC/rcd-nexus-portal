...
from nexus.utils.data import (
    ...
    load_legacy_profiles_data,
)

IPEDS_DATA = "data/ipeds_2024-01-16.csv"
HIST_PROFILES_DATA = "data/sensitive/capsmodel_2019-23_users.csv"
    ...
    def handle(self, *args, **options):
        ...
        if options["loadcmds"]:
            for loadcmd in options["loadcmds"]:
                ...
                elif loadcmd == "histprofiles":
                    load_legacy_profiles_data( HIST_PROFILES_DATA )
                else:
                    raise CommandError(
